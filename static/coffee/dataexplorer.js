...
class QueryResult {
    ...
    set(error, result) {
        if (error != null) {
            ...
            if (this.has_profile) {
                ...
                this.profile = null;
                this.server_duration = result != null ? result.profile[0]['duration(ms)'] : undefined;
                ({
                    value
                } = result);
            }
    ...
    discard() {
        ...
        __guardMethod__((this.cursor != null ? this.cursor.close() : undefined), 'catch', o => o.catch(() => null));
...
class Container extends Backbone.View {
    ...
    toggle_options(args) {
        ...
        this.deactivate_overflow();
        if ((args != null ? args.no_animation : undefined) === true) {
            ...
            this.adjust_collapsible_panel_height({
                cb: (args != null ? args.cb : undefined)});
        } else if (this.options_view.state === 'visible') {
            this.options_view.state = 'hidden';
    ...
    adjust_collapsible_panel_height(args) {
        let size;
        const that = this;
        if ((args != null ? args.size : undefined) != null) {
            ({
                size
            } = args);
        } else {
            if ((args != null ? args.extra : undefined) != null) {
        ...
        if ((args != null ? args.no_animation : undefined) === true) {
            ...
            this.$('.nano').animate(
                ...
                , function() {
                    ...
                    if ((args != null ? args.cb : undefined) != null) {
                        return args.cb();
                    }
            });
    ...
    initialize(args) {
        ...
        if (typeof (window.localStorage != null ? window.localStorage.current_query : undefined) === 'string') {
            try {
        ...
        if ((window.localStorage != null ? window.localStorage.rethinkdb_history : undefined) != null) {
            try {
        ...
        this.query_has_changed = (dataexplorer_state.query_result != null ? dataexplorer_state.query_result.current_query : undefined) !== dataexplorer_state.current_query;
    ...
    render() {
        ...
        if ((typeof navigator !== 'undefined' && navigator !== null ? navigator.appName : undefined) === 'Microsoft Internet Explorer') {
        ...
        if ((dataexplorer_state != null ? dataexplorer_state.query_result : undefined) != null) {
    ...
    pair_char(event, stack) {
        if ((event != null ? event.which : undefined) != null) {
    ...
    handle_keypress(editor, event) {
        ...
        if (this.ignored_next_keyup === true) {
            if (((event != null ? event.type : undefined) === 'keyup') && ((event != null ? event.which : undefined) !== 9)) {
        ...
        if ((event != null ? event.type : undefined) === 'mouseup') {
        ...
        if ((event != null ? event.which : undefined) != null) {
            ...
            if ((event.which === 27) || ((event.type === 'keydown') && (((event.ctrlKey === true) || (event.metaKey === true)) && (event.which === 32)) && ((this.$('.suggestion_description').css('display') !== 'none') || (this.$('.suggestion_name_list').css('display') !== 'none')))) {
                ...
                if ((result.suggestions != null ? result.suggestions.length : undefined) > 0) {
                ...
                if (event.type !== 'keydown') {
                    ...
                    if ((this.current_suggestions != null ? this.current_suggestions.length : undefined) > 0) {
                        ...
                        if ((this.extra_suggestions != null) && (this.extra_suggestions.length > 0) && (this.extra_suggestion.start_body === this.extra_suggestion.start_body)) {
                            // Trim suggestion
                            if (__guard__(__guard__(this.extra_suggestion != null ? this.extra_suggestion.body : undefined, x1 => x1[0]), x => x.type) === 'string') {
                            ...
                            if (this.extra_suggestions.length > 0) { // If there are still some valid suggestions
                                ...
                                if (__guard__(this.extra_suggestion.body != null ? this.extra_suggestion.body[0] : undefined, x2 => x2.name.length) != null) {
        ...
        if (this.$('.suggestion_name_li_hl').length > 0) {
            if ((event != null ? event.which : undefined) === 13) {
                event.preventDefault();
                this.handle_keypress();
                return true;
            }
        ...
        if (((event != null ? event.type : undefined) != null) && (event.type !== 'keyup') && (event.which !== 9) && (event.type !== 'mouseup')) {
            return false;
        }
        if ((event != null ? event.which : undefined) === 16) { // We don't do anything with Shift.
            return false;
        }

        // Tab is an exception, we let it pass (tab bring back suggestions) - What we want is to catch keydown
        if ((this.ignore_tab_keyup === true) && ((event != null ? event.which : undefined) === 9)) {
            if (event.type === 'keyup') {
                this.ignore_tab_keyup = false;
            }
            return true;
        ...
        if ((result_non_white_char_after_cursor !== null) && !((result_non_white_char_after_cursor[1] != null ? result_non_white_char_after_cursor[1][0] : undefined) in this.char_breakers || ((result_non_white_char_after_cursor[1] != null ? result_non_white_char_after_cursor[1].match(/^((\/\/)|(\/\*))/) : undefined) !== null))) {
        ...
        if ((result.suggestions != null ? result.suggestions.length : undefined) > 0) {
            ...
            this.hide_suggestion();
            this.description = result.description;
            if ((dataexplorer_state.options.suggestions === true) && ((event != null ? event.type : undefined) !== 'mouseup')) {
                this.show_description();
            } else {
                this.hide_description();
            }
        ...
        if ((event != null ? event.which : undefined) === 9) { // Catch tab
   ...
   // We build a stack of the query.
                ...
                if (element.type === null) {
                    ...
                    if (start === i) {
                        ...
                        if (result_regex !== null) {
                            ...
                            const list_args = result_regex[2] != null ? result_regex[2].split(',') : undefined;
                            element.args = [];
                        ...
                        if (result_regex !== null) {
                            ...
                            if (result_regex_row !== null) {
                                ...
                                if ((__guard__(stack[stack.length-1], x => x.type) === 'function') || (__guard__(stack[stack.length-1], x1 => x1.type) === 'var')) { // We want the query to start with r. or arg.
        ...
        return (() => {
            ...
            for (let i = stack.length-1; i >= 0; i--) {
                ...
                if ((element.body != null) && (element.body.length > 0) && (element.complete === false)) {
                    this.create_suggestion({
                        stack: element.body,
                        query: (args != null ? args.query : undefined),
                        result: args.result
                    });
                }
                ...
                if (result.status === null) {
                    ...
                    if (element.complete === true) {
                        if (element.type === 'function') {
                            if ((element.complete === true) || (element.name === '')) {
                                ...
                                if (__guard__(__guard__(element.body != null ? element.body[0] : undefined, x1 => x1.name), x => x.length) != null) {
                        ...
                        if (element.type === 'function') {
                            if (element.body != null) { // It means that element.body.length === 0
                                ...
                                if (__guard__(__guard__(element.body != null ? element.body[0] : undefined, x3 => x3.name), x2 => x2.length) != null) {
                                    this.cursor_for_auto_completion.ch -= element.body[0].name.length;
                                    this.current_extra_suggestion = element.body[0].name;
                                }
                                result.status = 'done';
                    ...
                    if (element.type === 'function') {
                        ...
                        if (__guard__(__guard__(element.body != null ? element.body[0] : undefined, x5 => x5.name), x4 => x4.length) != null) {
                            this.cursor_for_auto_completion.ch -= element.body[0].name.length;
                            this.current_extra_suggestion = element.body[0].name;
                        }
                        result.suggestions = null;
                ...
                if (result.status === 'break_and_look_for_description') {
                    if ((element.type === 'function') && (element.complete === false) && (element.name.indexOf('(') !== -1)) {
                        ...
                        if (__guard__(__guard__(element.body != null ? element.body[0] : undefined, x7 => x7.name), x6 => x6.length) != null) {
                            this.cursor_for_auto_completion.ch -= element.body[0].name.length;
                            this.current_extra_suggestion = element.body[0].name;
                        }
                        result.suggestions = null;
                        result1.push(result.status = 'done');
                    } else {
                        if (element.type !== 'function') {
                            break;
                        } else {
    ...
    abort_query() {
        ...
        if (dataexplorer_state.query_result != null) {
    ...
    toggle_executing(executing) {
        if (executing === this.executing) {
            if (executing && (dataexplorer_state.query_result != null ? dataexplorer_state.query_result.is_feed : undefined)) {
        ...
        if (executing) {
            return this.timeout_toggle_abort = setTimeout(() => {
                ...
                if (!(dataexplorer_state.query_result != null ? dataexplorer_state.query_result.is_feed : undefined)) {
...
class ResultView extends Backbone.View {
    ...
    setStackSize() {
        ...
        const iterableProto = __guard__(__guard__(__guard__(this.query_result.cursor != null ? this.query_result.cursor.__proto__ : undefined, x2 => x2.__proto__), x1 => x1.constructor), x => x.prototype);
        if ((iterableProto != null ? iterableProto.stackSize : undefined) > 12) {
...
class TreeView extends ResultView {
    ...
    render() {
        if ((this.query_result.results != null ? this.query_result.results.length : undefined) === 0) {
        ...
        switch (this.query_result.type) {
            ...
            case 'cursor':
                ...
                var tree_container = this.$('.json_tree_container');
...
class TableView extends ResultView {
    ...
    handle_mousedown(event) {
        if (__guard__(event != null ? event.target : undefined, x => x.className) === 'click_detector') {
    ...
    json_to_table_get_values(args) {
        ...
        for (let i = 0; i < result.length; i++) {
            ...
            for (let col = 0; col < flatten_attr.length; col++) {
                ...
                for (let prefix of Array.from(attr_obj.prefix)) {
                    value = value != null ? value[prefix] : undefined;
                }
...
class ResultViewWrapper extends Backbone.View {
    ...
    set_view(view) {
        ...
        if (this.query_result != null ? this.query_result.ready : undefined) {
    ...
    render_error(query, err, js_error) {
        if (this.view_object != null) {
            this.view_object.remove();
        }
        this.view_object = null;
        if (this.query_result != null) {
            this.query_result.discard();
        }
    ...
    render(args) {
        if (this.query_result != null ? this.query_result.ready : undefined) {
            ...
            const batch_size = this.view_object != null ? this.view_object.current_batch_size() : undefined;
            this.$el.html(this.template({
                range_begin: this.query_result.position + 1,
                range_end: batch_size && (this.query_result.position + batch_size),
                query_has_changed: (args != null ? args.query_has_changed : undefined),
            ...
            this.$('.tab-content').html(this.view_object != null ? this.view_object.$el : undefined);
            this.$(`.link_to_${this.view}_view`).parent().addClass('active');
        }
        return this;
    }
    ...
    cursor_timed_out() {
        ...
        if ((this.container.state.query_result != null ? this.container.state.query_result.ended : undefined) === true) {
    ...
    remove() {
        ...
        if (this.query_result != null ? this.query_result.is_feed : undefined) {
    ...
    show_next_batch(event) {
        ...
        return (this.view_object != null ? this.view_object.show_next_batch() : undefined);
    }
}
...
class DriverHandler {
    ...
    close_connection() {
        if ((this.connection != null ? this.connection.open : undefined) === true) {
